...
class Connector
{
     ...
     * @throws GeneralExceptionResponse
     * @throws GeneralErrorResponse
     */
    public function post($url, $requestXml)
    {
        ...
        $this->lastRequestHeader = isset($info['request_header']) ? $info['request_header'] : null; // PHPStan flags it as error, but request_header will arrive after curl_setopt($ch, CURLINFO_HEADER_OUT, true);
