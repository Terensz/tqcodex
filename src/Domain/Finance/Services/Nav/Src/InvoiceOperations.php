...
class InvoiceOperations
{
     ...
     *
     * @param  bool  $compression  gzip tömörítés alkalmazása, részletek: NAV dokumentáció, 1.6.5 Tömörítés és méretkorlát
     */
     ...
     *                                 [$operation = "CREATE"] Számlaművelet Enum(CREATE, MODIFY, STORNO, ANNUL)
     *                                 [$electronicInvoiceHash = null] Számla SHA3-512 hash értéke elektronikus számla esetén. Ha completenessIndicator=true, akkor itt null-t kell átadni.
     * @return int
     *             return: A beszúrt művelet sorszáma (index)
     *
     * @throws Exception
     */
     ...
     */
    public static function convertToXml($base64data, string|bool $isCompressed = false)
    {
