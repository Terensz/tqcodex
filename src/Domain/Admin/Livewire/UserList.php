...
final class UserList extends BaseListComponent
{
     ...
     * @var string
     */
    public $editRoute = 'admin.admin.user.edit';

    public $entityClassReference = 'user';
