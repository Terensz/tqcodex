...
namespace Domain\Project\Mails;
...
class PartnerInviteMail_markdownProbalkozas extends BaseMailable implements MailableInterface
{
    ...
    public function __construct($subject, $bodyMain, array $recipient, array $sender)
    {
        ...
        $body = StringHelper::replacePlaceholders($bodyLayout, [
            'subject' => $subject,
            'body-main' => $converter->convert($bodyMain),
        ]);
    ...
    {
        return new Content(
            markdown: 'emails.project.components.markdown.message',
            with: [
                'subject' => $this->subject,
                'slot' => $this->body,
            ],
...
// class PartnerInviteMail extends BaseMailable implements MailableInterface
// {
//     public const REFERENCE_CODE = 'PartnerInviteMail';
