    ...
    <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
      ...
      <div class="">
        <div class="mt-10 sm:mx-auto ">
          <form class="space-y-6" action="{{ route('admin.login') }}" method="POST" accept-charset="utf-8"
            ...
            <div>
              <div class="flex items-center justify-between">
                ...
                @endphp 
                @if (Route::has('admin.password.request') && $showPasswordRequestLink)
                <div class="text-sm">
                  <a href="{{ route('admin.password.request') }}" class="font-semibold text-blue-500 hover:text-blue-700">{{ __('user.DidYouForgetYourPassword') }}</a>
                </div>
                @endif
              </div>
              <div class="mt-2">
