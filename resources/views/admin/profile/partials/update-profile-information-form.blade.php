...
<section>
    ...
    <form method="post" action="{{ route('admin.profile.update', ['access_token' => AccessTokenService::getAccessToken(UserService::ROLE_TYPE_ADMIN)]) }}" class="mt-6 space-y-6">
        @csrf
        @method('patch')
        ...
        <div>
            ...
            <x-text-input id="email" name="email" class="mt-1 block w-full" :value="old('email', $user->email)" autocomplete="username" />
