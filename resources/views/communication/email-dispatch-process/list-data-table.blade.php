                    ...
                    <tr class="DataGrid-row">
                        @foreach($tableData as $fieldData)
                            ...
                            <td class="dataTable-td border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 dark:text-slate-400">
                                ...
                                */
                                $communicationCampaign = $object->communicationCampaign()->first();
                                // $organization = $object->organization()->first();
                                $propertyAlias = $fieldData[BaseListComponent::PROPERTY_ALIAS];
                                if ($fieldData[BaseListComponent::TABLE_ALIAS] == 'communicationdispatchprocesses') {
                                    $value = $object->$propertyAlias;
                                }
                                if ($fieldData[BaseListComponent::TABLE_ALIAS] == 'communicationcampaigns') {
                                    if ($propertyAlias == 'title_lang_ref') {
                                        $value = __($communicationCampaign->title_lang_ref);
                                    }
                                }
                                ?>
