...
#page-container {
  min-height: 100vh;
  width: 100%;
  display: flex; /* Added to ensure container occupies full height */
  flex-direction: column; /* Ensures children are stacked vertically */
}
.page {
  flex: 1; /* Ensures this div takes up remaining space */
  width: 100%;
  background-image: url('images/tq2_bg.jpg');
  ...
  init() {
    document.addEventListener('DOMContentLoaded', () => {
      ...
      if (this.userMenuButton && this.userMenu) {
        // Toggle the user menu visibility when clicking the button
        ...
        window.addEventListener('click', (e) => {
          if (this.userMenuButton && this.userMenu && !this.userMenuButton.contains(e.target) && !this.userMenu.contains(e.target)) {
