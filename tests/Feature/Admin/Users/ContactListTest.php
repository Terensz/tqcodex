...
/*
Standalone run:
php artisan test tests/Feature/Admin/Users/ContactListTest.php
*/

test('As Admin: listing all Contacts.', function () {
    ...
    $test = Livewire::test(\Domain\Admin\Livewire\ContactList::class)
